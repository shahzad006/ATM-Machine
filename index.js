...
if (pinAns.Pin === pin) {
    console.log(` ${chalk.greenBright("Correct Pin code!")} You have successfully!`);
    ...
    if (operationAns.operation === "Withdraw Amount") {
        let amountAns = await inquirer.prompt([
            {
                ...
                type: "list",
                choices: ["Enter Amount", "Fash Cash"],
            },
        ]);
        ...
        console.log(`Thank you for using the ATM. ${chalk.yellowBright("Goodbye!")} `);
    }
}
else {
